...
<body>
    ...
    <div class="register-container">
        ...
        <form method="post"  enctype="multipart/form-data">
            <input type="text" name="titrep" placeholder="titre produit" required>
        ...
        if(isset($_POST['btn'])){
	    	...
	    	copy($ph3['tmp_name'],$chemin3);
             ...
             $ajt=mysqli_query($conn,"insert into
              produit(titrep,description,prix,ville,idc,idu,ph1,ph2,ph3,datep)
              values('$titrep','$description','$prix','$ville','$idc','$idu','$chemin1','$chemin2','$chemin3','$datep')
              ");
